...
public final class Cord19Experimenter {
    ...
    public static void main(String[] args) throws IOException, ConfigurationException {
        ...
        exp = new Experiment<>(null, Cord19RetrievalRegistry.jlbasernd3(), TrecCovidTopicSetFactory.topicsRound3());
        exp.setRequestedMetrics(new String[]{"ndcg_cut_10", "P_5", "P_10", "Bpref", "MAP", "set_recall"});
        exp.run();

        exp = new Experiment<>(null, Cord19RetrievalRegistry.jlQERound3(), TrecCovidTopicSetFactory.topicsRound3());
        exp.setRequestedMetrics(new String[]{"ndcg_cut_10", "P_5", "P_10", "Bpref", "MAP", "set_recall"});
        exp.run();

        exp = new Experiment<>(null, new RRFResultListFusion(r -> (String) r.getSourceFields().get("cord19_uid")), TrecCovidTopicSetFactory.topicsRound3(), Cord19RetrievalRegistry.jlbasernd3(), Cord19RetrievalRegistry.jlQERound3());
        exp.setRequestedMetrics(new String[]{"ndcg_cut_10", "P_5", "P_10", "Bpref", "MAP", "set_recall"});
