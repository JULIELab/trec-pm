...
public class TrecQrelGoldStandardTest {
    ...
    public void writeQrels() throws IOException {
        ...
        final TrecQrelGoldStandard<Topic> gs = new TrecQrelGoldStandard<>(Challenge.TREC_PM, Task.PUBMED, 2018, GoldStandardType.INTERNAL, TOPICS, qrelDocuments);
    ...
    public void readAndWriteQrels() throws IOException {
        ...
        final File generatedQrels = testFolder.newFile("generated.qrels");
        final TrecQrelGoldStandard<Topic> gsCopy = new TrecQrelGoldStandard<>(Challenge.TREC_PM, Task.PUBMED, 2018, GoldStandardType.OFFICIAL, TOPICS, qrelDocuments);
